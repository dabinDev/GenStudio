...
export const adminRoutes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { title: '仪表盘', testId: 'admin-dashboard-view', permission: ADMIN_PERMISSIONS.recordView },
      },
      {
        path: 'models',
        name: 'admin-models',
        component: ModelCenterView,
        meta: { title: '模型中心', testId: 'admin-models-view', permission: ADMIN_PERMISSIONS.modelView },
      },
      {
        path: 'prompts',
        name: 'admin-prompts',
        component: PromptCenterView,
        meta: { title: '提示语中心', testId: 'admin-prompts-view', permission: ADMIN_PERMISSIONS.settingsView },
      },
      {
        path: 'users',
        name: 'admin-users',
        component: UserCreditsView,
        meta: { title: '用户与积分', testId: 'admin-users-view', permission: ADMIN_PERMISSIONS.userView },
      },
      {
        path: 'records',
        name: 'admin-records',
        component: RecordsView,
        meta: { title: '创作中心', testId: 'admin-records-view', permission: ADMIN_PERMISSIONS.recordView },
      },
      {
        path: 'audit',
        name: 'admin-audit',
        component: AuditLogsView,
        meta: { title: '审计日志', testId: 'admin-audit-view', permission: ADMIN_PERMISSIONS.auditView },
      },
      {
        path: 'settings',
        name: 'admin-settings',
      ...
      },
      {
        ...
        meta: { public: true, title: '无权访问', testId: 'admin-forbidden-view' },
      },
    ],
  },
];
